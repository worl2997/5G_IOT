...
import shutil
import os.path
from utils.cityscape_preprocessing import make_json2txt


#
def gather_json(gtFine_dir,type):
    if type == 'train' or type =='test':
        dest_dir = 'cityscape_devkit/trainval_json/train'
    else:
        dest_dir = 'cityscape_devkit/trainval_json/validation'
...
if __name__ == '__main__':
    gtFine_dir = "cityscape_devkit/gtFine_trainvaltest/gtFine"
    leftImg_dir = "cityscape_devkit/leftImg8bit_trainvaltest/leftImg8bit"
    # set the save path
