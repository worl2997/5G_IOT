...
'''
json_path => 'CITYSCAPESdevkit/trainval_json'
data_path -> cityscapes 
'''

def convert_annotation(json_path,data_path, type):
    os.makedirs(os.path.join(data_path,'labels',type)) # cityscapes/labels 폴더
    json_dir = os.path.join(json_path,type) # cityscapes_devkit/trainval_json 폴더
    ...
    for filename in file_list:
        ...
        #
        out_file = open('cityscapes/labels/%s/%s_leftImg8bit.txt' % (type,filename), 'w')
